import type { FlowStep as FlowStepType } from "@repo/web3";
import { useExplorerUrl } from "@repo/web3";

// ---------------------------------------------------------------------------
// Status icons — inline SVGs to avoid external icon library dependency
// ---------------------------------------------------------------------------
...
export function FlowStep({ step, isActive }: FlowStepProps) {
