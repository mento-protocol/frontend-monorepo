...
export function Footer() {
  ...
  const linkClassName =
    "relative flex items-center justify-center p-1 dark:text-white";

  return (
    <div className="z-10 inline-flex w-full justify-between p-3 pt-7 sm:px-5 sm:py-7">
      <div className="inline-flex items-start justify-start gap-4">
        ...
        >
          <XIcon size={iconSize} className={iconClassName} />
        </a>
        <a
          href={links.github}
          target="_blank"
          ...
          className={linkClassName}
        >
          <Github size={iconSize} className={iconClassName} />
        </a>
        <a
          href={links.discord}
          target="_blank"
