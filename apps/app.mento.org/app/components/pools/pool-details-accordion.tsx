...
export function PoolDetailsAccordion({ pool }: PoolDetailsAccordionProps) {
  ...
  if (pool.poolType === "Legacy") {
    return (
      <div className="px-6 py-5 border-t border-border bg-[oklch(0.16_0.028_303)]">
  ...
  return (
    <div className="px-6 py-5 space-y-6 border-t border-border bg-[oklch(0.16_0.028_303)]">
      {/* Two column layout */}
