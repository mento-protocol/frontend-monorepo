  ...
  return (
    <div className="mx-6 mt-4 mb-2 px-3.5 py-3.5 rounded-xl border border-border bg-muted/30">
      ...
      <div className="mb-2.5 flex items-baseline justify-between">
        <div className="gap-2.5 flex items-baseline">
      ...
      <div className="space-y-0">
        {[
          ...
          <div
            key={token.address}
            className="px-2 py-1.5 text-sm flex items-center justify-between rounded-lg transition-colors hover:bg-muted/50"
          >
            ...
            <div className="gap-2.5 flex items-baseline">
              ...
              {data.usdValue !== null && (
                <span className="text-xs font-mono min-w-13 text-right text-muted-foreground tabular-nums">
