...
export type QuoteCurrencyPriceHistory = Partial<
  Record<QuoteCurrency, TokenPriceHistory>
>;
export type BaseCurrencyPriceHistory = Partial<
  Record<TokenId, QuoteCurrencyPriceHistory>
>;
