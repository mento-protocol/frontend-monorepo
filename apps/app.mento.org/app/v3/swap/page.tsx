...
export default function V3SwapPage() {
  ...
  return (
    <>
      <div className="mt-14 flex h-full w-full flex-wrap items-center justify-center">
        <Toaster
          position="top-right"
          duration={5000}
          icons={{
        ...
        <div className="relative mb-6 w-full max-w-[568px]">
          ...
          >
            <div className="flex flex-row items-center justify-between gap-6">
              <h2 className="flex items-center gap-2 font-medium text-slate-900 md:text-2xl">
                {confirmView ? (
                  <Button
