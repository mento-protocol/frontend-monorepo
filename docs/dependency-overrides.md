...
| `brace-expansion`       | CVE fix, pinned to an exact patched version because transitive ranges didn't resolve to it on their own.                                                                                                                                                                              | `793a187`, version bumped in `68218a2` (PR #301)                                                  | Once `pnpm why -r brace-expansion` shows no transitive consumer below the patched version by default.                                                                     |
