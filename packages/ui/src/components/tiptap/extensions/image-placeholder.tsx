      ...
      <div className="relative">
        {!isExpanded ? (
          <div
            ...
            className={cn(
              "hover:bg-accent group relative flex cursor-pointer flex-col items-center gap-4 rounded-lg border-2 border-dashed p-8 transition-all",
