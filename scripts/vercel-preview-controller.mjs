...
const WORKER_RUN_IDENTITY_MAX_WAIT_MS = 30_000;
const WORKER_RUN_IDENTITY_RETRY_MS = 1_000;
const WORKER_RUN_IDENTITY_ATTEMPTS =
  1 + WORKER_RUN_IDENTITY_MAX_WAIT_MS / WORKER_RUN_IDENTITY_RETRY_MS;
